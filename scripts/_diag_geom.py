...
cur.execute("SELECT column_name, is_nullable FROM information_schema.columns WHERE table_schema='geo' AND table_name='field_crop_geometry' ORDER BY ordinal_position")
